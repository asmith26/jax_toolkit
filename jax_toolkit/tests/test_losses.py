...
class TestSquaredHinge(unittest.TestCase):
    def test_correctly_returns(self):
        ...
        # ToDo check hinge loss bounds and add validation accordingly (also add validation to other losses/metrics)
        # https://github.com/scikit-learn/scikit-learn/blob/fd237278e895b42abe8d8d09105cbb82dc2cbba7/sklearn/metrics/tests/test_classification.py#L2037
        actual_loss = squared_hinge(jnp.array([-1, 1, 1, -1]),
                                    jnp.array([-8.5, 0.5, 1.5, -0.3]))
        self.assertEqual(0.185, actual_loss)

        # https://github.com/tensorflow/tensorflow/blob/af7fd02ca40f362c4ac96dd064d6a2224b65d784/tensorflow/python/keras/losses_test.py#L1114
